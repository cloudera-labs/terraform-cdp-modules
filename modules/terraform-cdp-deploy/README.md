...
| <a name="input_custom_docker_registry"></a> [custom\_docker\_registry](#input\_custom\_docker\_registry) | The CRN of the desired custom docker registry for data services to be used. | <pre>set(object({<br/>    crn                          = string<br/>}))</pre> | `null` | no |
